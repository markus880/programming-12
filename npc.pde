void ap1(){
  background(0);
  image(bridget2,-300,180,800,800);
  textSize(30);
  textAlign(LEFT,LEFT);
  fill(255);
  text("WOW I'M IMPRESSED! YOUR SKILLS ARE GROWING RAPIDLY, AND THEY  ",300,100+300);
...
void ap2(){
  ...
  textAlign(LEFT,LEFT);
    fill(255);
  text("THANKS FOR FINDING IT! FOR YOUR EFFORTS YOU GET GRAVITY BOOTS. THESE  ",300,100+300);
  text("WILL INVERT GRAVITY AT WILL. NOW ALL THATS LEFT TO DO IS DEFEAT THE",300,150+300);
